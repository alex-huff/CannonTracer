...
public
class TracerUser implements Serializable
{
    ...
    private
    TracerUser(boolean trace, boolean traceSand, boolean traceTNT, boolean tracePlayer, boolean endPosSand,
               boolean endPosTNT, boolean startPosSand, boolean startPosTNT, boolean tickConnect, boolean hypotenusal,
               double minDistance, double traceRadius, double viewRadius, int maxParticles, int traceTime)
    {
        this.trace        = trace;
    ...
    public
    boolean isTracePlayer()
    {
        return tracePlayer;
    }

    public
    void toggleTracePlayer()
    {
        this.tracePlayer = !this.tracePlayer;
    }

    public
    boolean isEndPosSand()
    {
        return endPosSand;
    }

    public
    void toggleEndPosSand()
    {
    ...
    public
    void toggleEndPosTNT()
    {
        this.endPosTNT = !this.endPosTNT;
    }

    public
    boolean isStartPosSand()
    {
        return startPosSand;
    }

    public
    void toggleStartPosSand()
    {
        this.startPosSand = !this.startPosSand;
    }

    public
    boolean isStartPosTNT()
    {
        return startPosTNT;
    }

    public
    void toggleStartPosTNT()
    {
        this.startPosTNT = !this.startPosTNT;
    }

    public
    boolean isTickConnect()
    {
        return tickConnect;
    }

    public
    void toggleTickConnect()
    {
    ...
    public
    double getTraceRadius()
    {
        return traceRadius;
    }

    public
    void setTraceRadius(double traceRadius)
    {
        this.traceRadius = traceRadius;
    }
    ...
    public
    void setTraceTime(int traceTime)
    {
        this.traceTime = traceTime;
    }

    public
    Set<ParticleLocation> getParticleLocations()
    {
        this.unNull();
    ...
    void clearTNT()
    {
        ...
        this.pLocs.removeIf(pLocation -> pLocation.getType().compareTo(ParticleType.TNT) == 0 ||
                                         pLocation.getType().compareTo(ParticleType.TNTENDPOS) == 0);
    }
    ...
    void clearSand()
    {
        ...
        this.pLocs.removeIf(pLocation -> pLocation.getType().equals(ParticleType.SAND) ||
                                         pLocation.getType().equals(ParticleType.SANDENDPOS));
    }
    ...
    private
    void addAllParticles(Iterable<ParticleLocation> pI)
    {
        this.unNull();

        if (this.pLocs.size() != 0 &&
            !(this.pLocs.iterator().next().getLocation().getWorld() == pI.iterator().next().getLocation().getWorld()))
        {
            this.pLocs.clear();
        }
    ...
    public
    void updateRadius(Location loc)
    {
        this.unNull();
        ...
        else
        {
            ...
            PriorityQueue<ParticleLocation> pq   = new PriorityQueue<>(
                (new ParticleLocationComparator(loc)).reversed());
    ...
    String printSettings()
    {
        ...
        message += ChatColor.AQUA + "Trace enabled:             " + ChatColor.WHITE + this.isTrace() + "\n" +
    ...
    public
    void copySettings(TracerUser other)
    {
